...
def extract_sentences(epub_path: str, char_start: int = 0, char_end: int = None) -> list[str]:
    """
    Open EPUB, extract plain text, optionally slice to [char_start:char_end],
...
def get_total_chars(epub_path: str) -> int:
    """Return the total character count of the EPUB's extracted text."""
    return len(extract_text(epub_path))
